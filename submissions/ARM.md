...
- Local planner implemented: optional CPU-only `llama-cli` inference uses a strict JSON schema, deterministic sampling, bounded governed context, and the existing approval guardrails.
