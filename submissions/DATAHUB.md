...
- Required integration: DataHub Core plus open-source `mcp-server-datahub`.
- Repository license: Apache-2.0, visible at repository root.
...
- The shared project story now links the evidence directory. The optional artifact-example field can receive the same URL during final submission.
